...
module.exports = (app) => {
  ...
  app.put("/wishlist", UserAuth, async (req, res, next) => {
    ...
    try {
      ...
      PublishCustomerEvent({
        ...
        data: { userId: _id, product: product, order: null, qty: null },
      });
  ...
  app.delete("/wishlist/:id", UserAuth, async (req, res, next) => {
    ...
    try {
      ...
      PublishCustomerEvent({
        ...
        data: { userId: _id, product: { p_id: productId } },
      });
  ...
  app.put("/cart", UserAuth, async (req, res, next) => {
    ...
    try {
      ...
      PublishCustomerEvent({
        event: "ADD_TO_CART",
        data: { userId: req.user._id, product: product, order: null, qty: qty },
      });
  ...
  app.delete("/cart/:id", UserAuth, async (req, res, next) => {
    ...
    try {
      ...
      PublishCustomerEvent({
        ...
        data: { userId: _id, product: product, qty: 0 },
      });
      return res.status(200).json(result);
    } catch (err) {
      next(err);
